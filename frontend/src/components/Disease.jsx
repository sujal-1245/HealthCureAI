...
export default function Disease() {
  ...
  >
    ...
    <select
      className="w-full sm:w-28 px-3 py-2 bg-white bg-opacity-60 backdrop-blur-md border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
      value={s.severity}
...
<div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
  <button
    onClick={add}
    className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-yellow-500 hover:bg-blue-600 text-white rounded-lg shadow-md transition"
  >
    <FaPlus /> Add Symptom
  </button>
  <motion.button
    ...
    className="w-full sm:w-auto px-8 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg shadow-md"
  >
    Predict
  </motion.button>
</div>
